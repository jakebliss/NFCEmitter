...
public class ChargeService extends HostApduService {
    ...
    // AID for our charge service
    private static final String SAMPLE_CHARGE_AID = "F222222222";
    ...
    private static final byte[] SELECT_APDU = BuildSelectApdu(SAMPLE_CHARGE_AID);
